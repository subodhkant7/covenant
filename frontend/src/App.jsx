...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#090d12] text-slate-200 flex flex-col font-sans">
      ...
      {/* Main Content Area */}
      <main className="w-full px-6 sm:px-8 lg:px-10 xl:px-12 py-6 flex-1">
        {loading ? (
      ...
      <footer className="border-t border-slate-800/80 bg-[#0d121a] py-3 text-xs font-mono text-slate-400">
        <div className="w-full px-6 sm:px-8 lg:px-10 xl:px-12 flex flex-col sm:flex-row items-center justify-between gap-2">
          <div>
            <span>Workspace: </span>
